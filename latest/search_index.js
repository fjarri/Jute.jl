...

{
    ...
    "category": "section",
    "text": "A global fixture is a more sophisticated variant of a constant fixture that has a setup and a teardown stage. For each global fixture, the setup is called before the first testcase that uses it. As for the teardown, it is either called right away (if the keyword parameter delayed_teardown is false), or after the last testcase that uses it (if delayed_teardown is true). If no testcases use it (for example, they were filtered out), neither setup nor teardown will be called.The setup and the teardown are defined by use of a single coroutine that produces the fixture iterable. The coroutine's first argument is a function that is used to return the fixture values. If delayed_teardown is true, the call blocks until it is time to execute the teardown:db_connection = fixture(; delayed_teardown=true) do produce\n    c = db_connect()\n\n    # this call blocks until all the testcases\n    # that use the fixture are executed\n    produce([c])\n\n    close(c)\nendNote that a global fixture must produce the whole iterable in one go.Similarly to the constant fixture case, one can provide a custom identifier for the fixture via the optional second argument of produce():db_connection = fixture(; delayed_teardown=true) do produce\n    c = db_connect()\n\n    # this call blocks until all the testcases\n    # that use the fixture are executed\n    produce([c], [\"db_connection\"])\n\n    close(c)\nendGlobal fixtures can be parametrized by other constant or global fixtures. Similarly to the test parametrization, all possible combinations of parameters will be used to produce iterables, which will be chained together:fx1 = fixture() do produce\n    produce(3:4)\nend\n\nfx2 = fixture(1:2, fx1) do produce, x, y\n    produce([(x, y)])\nend\n\ntc = testcase(fx2) do x\n    @test length(x) == 2\nend\n\n# Output:\n# tc[(1, 3)]: [PASS]\n# tc[(1, 4)]: [PASS]\n# tc[(2, 3)]: [PASS]\n# tc[(2, 4)]: [PASS]"
},
...
{
    "location": "public.html#Jute.RunOptions",
    "page": "Public API",
    "title": "Jute.RunOptions",
    "category": "Type",
    "text": "A set of options for running the test suite.\n\n\n\n"
},

{
    "location": "public.html#Run-options-1",
    "page": "Public API",
    "title": "Run options",
    "category": "section",
    "text": "RunOptionsSee also the builtin fixture run_options if you want to access the options in a testcase."
},

{
    ...
    "category": "Constant",
    "text": "A global fixture that contains the current RunOptions object\n\n\n\n"
},
...

{
    ...
    "title": "Utilities",
    "category": "section",
    "text": "rowmajor_productpprint_time"
},
